...
const SYSTEM_PROMPT = [
  ...
  "ni le nom ni l'historique) ; DUPLIQUER une fiche en variante proche — même personne, autre",
  "entreprise (duplicateContact) ; rédiger un message dans la voix de l'utilisateur, APRÈS avoir",
  ...
  "DUPLICATION (duplicateContact) : résous la source via queryContacts, ANNONCE le NOM de la source",
  "ET ce qui change (au moins une entreprise ou un e-mail DIFFÉRENT pour une fiche distincte), et",
  "n'agis qu'après accord. Si l'outil refuse (copie identique à un contact existant), explique-le",
  "doucement et propose de préciser le changement ou de modifier la fiche existante.",
