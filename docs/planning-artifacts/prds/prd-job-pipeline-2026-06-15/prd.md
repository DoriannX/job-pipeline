...
> **⚠️ PIVOT 2026-06-21 (dogfood) — surface IA one-shot dépréciée.** La rédaction assistée par IA **quitte le composeur one-shot** pour le **copilote conversationnel** (l'IA pose toujours des questions avant de rédiger, et à la création d'un contact). FR-6→FR-14 / FR-35 : le *quoi* (générer/améliorer dans la voix, canal-aware, sanitize, few-shot, choix modèle, historique) est **préservé et re-routé** ; le *comment one-shot* (bouton « Générer ») **disparaît comme concept**. L'application ne porte plus que la rédaction **manuelle** ; toute l'IA vit dans le copilote. Nouveaux **FR-36→FR-39** (choix IA/manuel par message · conversationnel full · capture du contexte à la création de contact · write-tools d'édition de fiche). Le **Jalon R1 / SM-1** est à redéfinir pour la voie conversationnelle. Détail : [sprint-change-proposal-2026-06-21-pivot-copilote.md](../../sprint-change-proposal-2026-06-21-pivot-copilote.md). _(Les FR ci-dessous restent la trace du mécanisme one-shot ; leur réalisation cible est désormais l'Epic 7.)_
